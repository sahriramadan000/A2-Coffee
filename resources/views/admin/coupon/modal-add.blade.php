            ...
            <div class="modal-body">
                ...
                <div class="mt-0 row">
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text" id="group-rp">Rp</span>
                            <input type="text" name="discount_threshold" id="discount_threshold" class="form-control form-control-sm" aria-label="Discount Threshold" placeholder="Ex:10.000" value="{{ old('discount_threshold') }}">
                        </div>
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text" id="group-rp">Rp</span>
                            <input type="text" name="max_discount_value" id="max_discount_value" class="form-control form-control-sm" aria-label="Max Discount Value" placeholder="Ex:10.000" value="{{ old('max_discount_value') }}">
                        </div>
