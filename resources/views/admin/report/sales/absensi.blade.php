...
<div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
    ...
    <div class="widget-content widget-content-area br-8">
        <table id="report-absensi-table" class="table dt-table-hover" style="width:100%">
            <thead>
                <tr>
                    <th width="7%">No</th>
                    <th>Nama</th>
...
<script>
    $(document).ready(function() {
        $('#report-absensi-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('report.sales.get-report-absensi') }}",
                data: function(d) {
                ...
                error: function(xhr, textStatus, errorThrown) {
                    $('#report-absensi-table').DataTable().clear().draw();
