        ...
        <div class="widget-content">
            <div class="media">
                ...
                <div class="media-body d-flex justify-content-between align-items-center ms-2">
                    ...
                    <div class="">
                        <button class="btn btn-success btn-custom stores-add" data-bs-target="#passwordModal">Open Store</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing bg-transparent">
                ...
                <div class="widget-content widget-content-area br-8 border-0" style="background: transparent !important; box-shadow:none;">
                    <table id="store-table" class="table dt-table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th width="7%">No</th>
                                <th>Open Store</th>
...
<script>
    $(document).ready(function() {
        ...
        $('#store-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('stores.get-data') }}",
                error: function(xhr, textStatus, errorThrown) {
                    $('#store-table').DataTable().clear().draw(); // Bersihkan tabel
            ...
            columns: [
                ...
                { data: 'open_store', name: 'open_store' },
                { data: 'close_store', name: 'close_store' },
        ...
        $(document).on('click', '.stores-add', function() {
            var getTarget = $(this).data('bs-target');

            $.get("{{ route('stores.modal-add') }}", function(data) {
